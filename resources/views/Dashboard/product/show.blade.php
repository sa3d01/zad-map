                ...
                <div class="col-xl-12">
                    <div class="card-box">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><strong>مزود الخدمة : </strong><span><a href="{{route('admin.provider.show',$product->user->provider->id)}}"> {{$product->user->provider->name}}</a></span></li>
