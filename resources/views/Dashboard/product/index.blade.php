                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-list">
                                            ...
                                            @if($row->status==1)
                                                <form class="ban" data-id="{{$row->id}}" method="POST" action="{{ route('admin.product.ban',[$row->id]) }}">
                                                    @csrf
                                                    {{ method_field('POST') }}
                                                    <button class="btn btn-danger waves-effect waves-light"> <i class="fa fa-archive mr-1"></i> <span>حظر</span> </button>
                                                </form>
                                            @else
                                                <form class="activate" data-id="{{$row->id}}" method="POST" action="{{ route('admin.product.activate',[$row->id]) }}">
                                                    @csrf
                                                    {{ method_field('POST') }}
