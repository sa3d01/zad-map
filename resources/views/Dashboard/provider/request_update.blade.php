...
@section('title', 'مزودى الخدمات الطالبين لتعديل ملفاتهم الشخصية')
@section('styles')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-list">
                                            <a href="{{route('admin.provider.show_request',$row->id)}}">
                                                <button class="btn btn-info waves-effect waves-light"> <i class="fa fa-eye mr-1"></i> <span>عرض</span> </button>
                                            </a>
                                            <form class="reject" data-href="{{ route('admin.provider.reject_request',[$row->id]) }}" data-id="{{$row->id}}">
                                                @csrf
                                                <button class="btn btn-danger waves-effect waves-light"> <i class="fa fa-archive mr-1"></i> <span>رفض</span> </button>
                                            </form>
                                            <form class="accept" data-id="{{$row->id}}" data-href="{{ route('admin.provider.accept_request',[$row->id]) }}">
                                                @csrf
